...
public class Util_Readtestdata {
	...
	public Util_Readtestdata(String path){
		this.path=path;	
		try{
 ...
 /*	public static void main(String arg[]) throws IOException{
 		...
 		//System.out.println(filename);
 		 Util_Readtestdata datatable = null;
 		 datatable = new  Util_Readtestdata("/testdata/testdata.xlsx");
